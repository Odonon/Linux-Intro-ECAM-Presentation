...
\begin{frame}
	...
	\begin{tikzpicture}
		\node[draw,align=center] (GNU) {\includegraphics[width=4cm]{static/img/GNU_white.png}\\ \href{https://fr.wikipedia.org/wiki/Logiciel_libre}{GNU Project}};
...
\begin{frame}
	...
	\includegraphics[width=.45\linewidth]{static/img/open-source.png} \hfill \includegraphics[width=.45\linewidth]{static/img/nsa.png}
...
\begin{frame}
	...
	\begin{center}
		\href{https://upload.wikimedia.org/wikipedia/commons/1/1b/Linux_Distribution_Timeline.svg}{\includegraphics[width=3cm,angle=-90]{static/img/linux_timeline.png}}
	\end{center}
\end{frame}
...
\begin{frame}{Obsolescence programmée ?}
	...
	\onslide<3->{\begin{center}
			{\color{red}300 000\texteuro\ d'amende
...
\begin{frame}{Questions}
	\begin{block}{Question 2}
		Un constructeur d'ordinateur portable choisit de faire en sorte que la batterie de ses machines soient collées, rendant le démontage quasi impossible et le changement de machine presque obligatoire. Est-ce de l'obsolescence programmée ?
	\end{block}
\end{frame}

\begin{frame}{Questions}
	\begin{block}{Question 3}
		Un éditeur de logiciel fait une mise à jour d'un de ses produits gratuits, le rendant se faisant plus lent sur certains appareils et forçant l'utilisateur à prendre un abonnement payant pour un autre produit. Est-ce de l'obsolescence programmée ?
	\end{block}
\end{frame}
